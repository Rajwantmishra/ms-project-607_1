...
(1) Loading the specific R packages we felt that could solve this problem easily. *CHANGE `TIDYVERSE' TO "R PACKAGES"*
![https://github.com/Rajwantmishra/ms-project-607_1/blob/master/Slide2.PNG] Step 1

(2) The different methods of cleaning and formatting with text file
![https://github.com/Rajwantmishra/ms-project-607_1/blob/master/Slide3.PNG] Step 2

(3) Lastly, buliding and exporting the final CSV 
![https://github.com/Rajwantmishra/ms-project-607_1/blob/master/Slide4.PNG] Step 3
